...
COPY --from=builder /app/LICENSE /app/THIRD_PARTY_NOTICES.md /usr/share/licenses/yukimind/
...
ARG VCS_REF=unknown
LABEL org.opencontainers.image.title="YukiMind" \
      org.opencontainers.image.source="https://github.com/Rick2857/YukiMind" \
