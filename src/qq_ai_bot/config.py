...
from qq_ai_bot.prompting.models import MAX_PROMPT_CONTRIBUTION_CHARACTERS
...
class Settings(BaseSettings):
    ...
    def _load_system_prompt_file(self) -> Self:
        ...
        if len(self.system_prompt) > MAX_PROMPT_CONTRIBUTION_CHARACTERS:
            raise ValueError(
                "SYSTEM_PROMPT_FILE/system_prompt must not exceed "
                f"{MAX_PROMPT_CONTRIBUTION_CHARACTERS} characters"
            )
        return self
