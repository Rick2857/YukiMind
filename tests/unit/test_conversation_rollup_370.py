...
def test_rollup_source_projection_renders_stored_utc_in_default_timezone() -> None:
    event = EventRecord(
        id=32865,
        bot_user_id="80001",
        platform_message_id="sample-image",
        scope_type=ScopeType.GROUP,
        sender_user_id="10001",
        sender_group_card="测试成员甲",
        direction="inbound",
        content="这是什么",
        visual_summary="",
        segments=(),
    ...
    assert rollup_source_projection(event) == ("[2026-08-20T19:21:42+08:00] 测试成员甲: 这是什么")
