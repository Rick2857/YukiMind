...
```text
/github add YuanYeYouTao/Yuki-QQbot group:<群号>
```

向 QQ `<QQ号>` 私聊推送：

```text
/github add YuanYeYouTao/Yuki-QQbot private:<QQ号>
```
...
```text
/ai plugin run github-monitor github add YuanYeYouTao/Yuki-QQbot group:<群号>
```
